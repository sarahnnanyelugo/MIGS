        ...
        <div className="col-md-10 flexy  offset-md-1">
          <div className="col-md-6">
            <div className="col-md-11">
              ...
              <ol>
                <li>
                  <strong> Harmonious Melodies: </strong>Immerse yourself in the
                  symphony of our multi-instrumental orchestra. Witness the
          ...
          <div className="col-md-6">
            <div className="col-md-11">
              ...
              <ol className="mt7">
                <li>
                  5. Engaging Extracurricular: Our commitment to holistic
                  development shines through our expansive array of
                ...
                <li>
                  {" "}
                  6. Intellectual Discourse: Our classrooms become vibrant hubs
                  of intellectual discourse, where students engage in
                  stimulating discussions, debates, and collaborative learning
                  experiences. We encourage critical thinking, embrace diversity
                  of thought, and foster a culture of curiosity, ensuring that
                  students develop into insightful and articulate individuals.
                </li>
                <li>
                  7. Coaching and Guidance: GJHS students are guided by a team
                  of dedicated teachers and a dedicated and compassionate
                  guidance counselor who provide unwavering support and nurture
                  their individual growth. We believe in the power of
                  personalized attention, fostering strong student-teacher
                  relationships that inspire intellectual curiosity and foster a
