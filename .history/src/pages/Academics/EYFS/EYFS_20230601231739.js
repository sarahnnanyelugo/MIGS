  ...
  return (
    <>
      ...
      <div className="col-md-12  flexy">
        ...
        <div className="col-md-3 curriculum creche">
          <ul>
        ...
        <div className="col-md-3 curriculum ladybird flexy flexyM">
          <ul>
        ...
        <div className="col-md-4 curriculum bumble flexy flexyM">
          <ul>
      ...
      <div className="col-md-8  offset-md-1 flexy">
        <div className="col-md-6">
        ...
        <div className="col-md-6">
          <div className="col-md-11 curriculum busyflexy flexyM">
            <ul>
              <li></li>
              <li></li>
              <li></li>
