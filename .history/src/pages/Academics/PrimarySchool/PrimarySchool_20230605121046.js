  ...
  return (
    <>
      ...
      <div className="col-md-6 offset-md-1">
        <p>
          5. Best of Both Worlds: Our curriculum is a magical blend of the
          Pearson International Primary Curriculum (IPC) and the rich Nigerian
          curriculum. This unique combination ensures that our students receive
          a well-rounded education that combines global perspectives with a deep
          understanding of their own culture and heritage.
        </p>
        <p>
          6. Enriching Experiences: Excursions, guest speakers, and hands-on
          projects are just a few of the exciting experiences we offer to enrich
          learning beyond the classroom walls. We believe that real-world
          connections make learning more meaningful and unforgettable.
        </p>
        <p>
          7. Supportive Community: Our school is more than just a place of
          learning; it’s a warm and inclusive community. We foster strong
          partnerships with parents, ensuring open lines of communication and
          collaborative efforts to support each child’s growth and success. So,
          come join us in our Primary Section, where education is an adventure,
          friendships are forged, dreams take flight, and every child’s
          potential is celebrated. Together, let’s create unforgettable memories
          and lay the foundation for a bright future!
        </p>
        <p></p>
      </div>
      <br />
