      ...
      <div className="col-md-10 offset-md-1 flexy">
        <div className="col-md-8">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              {" "}
              2. Extracurricular: We believe that education goes beyond
              textbooks. That’s why we have a robust extracurricular department
              that offers a wide range of activities to cater to every interest.
              From sports to arts, music to STEM, there’s something for everyone
              to discover their passion and unleash their hidden talents.{" "}
            </li>
            <li>
              {" "}
              3. Bible Club: As a school rooted in the Christian faith, we offer
              a free Bible club where children can deepen their spiritual
            ...
            <li>
              ...
              communication. Our elocution classes help students develop
              excellent public speaking skills, express themselves confidently,
              and become eloquent storytellers who captivate audiences with
              their words.
            </li>
          </ul>
        </div>
