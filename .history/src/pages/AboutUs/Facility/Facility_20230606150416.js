  ...
  return (
    <>
      ...
      <ul className=" offset-md-1 facility-list col-md-10">
        <li>
          Library: Our extensive collection of books, predominantly authored by
          esteemed international scholars, is readily accessible to both staff
          and students for reading and borrowing. Our dedicated library staff
          provides invaluable assistance to users.
        </li>
        <li>
          Swimming Pool: A pristine pool for recreational and educational
          purposes, promoting physical fitness and water-based activities.
        </li>
        <li>
          {" "}
          Play Spaces: Enchanting and safe indoor and outdoor areas designed to
          stimulate imaginative play and promote physical development.
        </li>
      </ul>
      <Tour />
      <Prefooter />
