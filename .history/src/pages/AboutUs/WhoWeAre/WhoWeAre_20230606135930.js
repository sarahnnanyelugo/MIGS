    ...
    <>
      ...
      <div className="col-md-10 offset-md-1 flexy">
        ...
        <div className="col-md-6">
          ...
          <p>
            <strong> 6. Goldsprings Junior High Day School: </strong>Catering to
            the educational needs of Year 7, Year 8, and Year 9 students.
          </p>
          <p>
            <strong>7. Goldsprings Senior High Boarding School:</strong>{" "}
            Dedicated to Year 10, Year 11, and Year 12 students, providing a
            comprehensive boarding experience under the guidance of a Principal
            and a team of dedicated educators and support staff.{" "}
          </p>
          <p>
