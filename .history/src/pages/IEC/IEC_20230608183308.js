...
import LandingImg from "../../assets/images/iec-bg.png";
      ...
      <div className="iec-container">
        ...
        <center>
          <div className="col-md-8">
            <h1 className="grey-heading">Inspire Education Consult</h1>
            <p>
            ...
            <div className="flexy what-we-do">
              <div className="col-md-3">
                <center>
                  <div className="col-md-10">
                    <img className="" src={IconOne} alt="Scholar" width="25%" />{" "}
              ...
              <div className="col-md-3">
                <center>
                  <div className="col-md-10">
                    <img className="" src={IconTwo} alt="Scholar" width="20%" />{" "}
            ...
            <div className="col-md-2 iec-btn">
              {" "}
        ...
        <div className="offset-md-1">
          ...
          <ul className="list-unstyled iec-list">
            <li>
              ...
              <br />
              <a href="#" target="_blank" style={{ marginleft: "40px" }}>
