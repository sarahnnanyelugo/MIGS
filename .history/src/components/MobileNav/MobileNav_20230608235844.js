  ...
  return (
    <>
      ...
      <Offcanvas
        ...
        restoreFocus={true}
        scroll={false}
        className="backdropClassName mobile-nav"
        {...props}
      ...
      >
        ...
        <Offcanvas.Body>
          <div class="list-group options ">
            ...
            <NavLink to={"/eyfs"} className="menu-navs">
              {" "}
              <button
                type="button"
                class="list-group-item list-group-item-action"
            ...
            <a
              href=" https://misg.educare.school/default.html#/admin/dashboard"
              target="_blank"
              className="menu-navs portal"
            >
              {" "}
              <button
                type="button"
